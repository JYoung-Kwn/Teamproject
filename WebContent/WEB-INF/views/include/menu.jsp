...
<div class="menu">
	<ul>
		...
		<li class="chapter">Ch11. <a href="<%=application.getContextPath()%>/ch11/content">View - Tag Library</a></li>
		<li class="chapter">Ch12. <a href="<%=application.getContextPath()%>/ch12/content">View - BeanName_ViewResolve</a></li>
		<li class="chapter">Ch13. <a href="<%=application.getContextPath()%>/ch13/content">DI(Dependency Injection)</a></li>
		<li class="chapter">Ch14. <a href="<%=application.getContextPath()%>/ch14/content">DAO</a></li>
	</ul>
</div>